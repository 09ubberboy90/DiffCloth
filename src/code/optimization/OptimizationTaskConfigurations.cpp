...
Simulation::SceneConfiguration OptimizationTaskConfigurations::dressScene = {
    ...
    .customAttachmentVertexIdx = {
        {
            0.0, {
                1335, 1336, 1334, 1360, 1339, 1347, 1345, 1342, 1349, 1351, 1352, 3604, 1145, 1150,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::slopeSimplifiedScene{
    // solution mu: 0-0.8
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::sockScene{
    ...
    .trajectory = TrajectoryConfigs::FIXED_POINT_TRAJECTORY,

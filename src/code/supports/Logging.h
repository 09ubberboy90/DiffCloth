...
class Logging
{
    static std::string RED_START, BLACK_START, WHITE_START, YELLOW_START, MAGENTA_START, CYAN_START, GREEN_START,
                       BLUE_START;
...
public:
    enum LogColor
    {
        RED, WHITE, BLACK, GREEN, YELLOW, BLUE, CYAN, MAGENTA, TOTAL_OPTIONS
    };
